...
public class MOAH52014 {
    ...
    public static int h3(int[][] matriz){
    ...
    public static int h2(int[][] matriz){
        int[][] original = {{1, 5, 9, 13},{2, 6, 10, 14},{3, 7, 11, 15},{4, 8, 12, 0}};
        int dif = 0;
        int a;
        int b;
    ...
    public static int h1(int[][] matriz){
        int[][] original = {{1, 5, 9, 13},{2, 6, 10, 14},{3, 7, 11, 15},{4, 8, 12, 0}};
        int dif = 0;
        int a;
        int b;
    ...
    public static void principal(int[][] matrizatual, double c1, double c2, double c3){

    Multimap<Integer, String> open_list = TreeMultimap.create(); 
    HashMap<String, Estado> processados = new HashMap();

    int h1x = h1(matrizatual);
    int h2x = h2(matrizatual);
    int h3x = h3(matrizatual);
    ...
    double c2 = 0.3;
    double c3 = 0.4;
    MOAH52014.principal(caso1, c1, c2, c3);
    }
